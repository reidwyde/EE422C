...
7.	Compare each output.txt to the corresponding expected_output.txt.  When comparing the output with the provided golden output, ignore blank line differences.  For example, the Unix command 'diff -B' may be used.
